...
public class AllProductsShareActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inputSearch.addTextChangedListener(new TextWatcher() {
			public void afterTextChanged(Editable s) {
				...
				ListAdapter adapter = new SimpleAdapter(
						AllProductsShareActivity.this, productsList_sort,
		...
		btnReturn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				AllProductsShareActivity.this.finish();
			}
		});
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(AllProductsShareActivity.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					 ...
					 * */
					ListAdapter adapter = new SimpleAdapter(
							AllProductsShareActivity.this, productsList,
